            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white shadow-sm rounded-xl border border-gray-200 p-6">
                        ...
                        <div class="space-y-3">
                            <a href="{{ route('admin.menus.create') }}" class="flex items-center justify-between w-full px-4 py-3 bg-red-600 hover:bg-red-700 text-white rounded-lg transition-all shadow-md shadow-red-100 group">
                            ...
                            <a href="{{ route('admin.pesanan.index') }}" class="flex items-center justify-between w-full px-4 py-3 bg-gray-900 hover:bg-gray-800 text-white rounded-lg transition-all shadow-md group">
                            ...
                            <a href="{{ route('admin.menus.index') }}" class="flex items-center justify-between w-full px-4 py-3 bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 rounded-lg transition-all group">
