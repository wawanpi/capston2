                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div class="flex items-center gap-4 mt-10">
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="flex-1 px-6 py-3 bg-white border border-gray-200 text-gray-600 rounded-full font-bold text-center shadow-md hover:shadow-lg hover:bg-gray-50 hover:text-gray-900 hover:-translate-y-1 transition-all duration-300 text-base">
                                Daftar
                            </a>
                        @endif
                    </div>
                    ...
                    @if (Route::has('password.request'))
                        <div class="mt-8 w-full text-center">
                            <a class="text-sm text-gray-400 hover:text-red-600 transition-colors" href="{{ route('password.request') }}">
