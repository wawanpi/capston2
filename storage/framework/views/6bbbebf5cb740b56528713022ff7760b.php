                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                            ...
                                            <?php if($pesanan->status == 'completed' && $pesanan->reviews->isEmpty()): ?>
                                                <a href="<?php echo e(route('reviews.create', $pesanan->id)); ?>" class="text-yellow-600 hover:text-yellow-900 ml-4">
                                                    Beri Ulasan
                                                </a>
...
<?php endif; ?><?php /**PATH D:\Capstone\capstone 2\capston2\resources\views/my-orders.blade.php ENDPATH**/ ?>