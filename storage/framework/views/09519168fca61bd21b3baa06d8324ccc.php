...
<footer class="bg-gradient-to-b from-[#1a1a1a] via-[#8B1E1E] to-black text-white mt-16">
    ...
    <div class="container mx-auto px-4 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div>
                <h4 class="font-bold text-yellow-400 text-lg mb-3 flex items-center gap-2">
                    <i class="fas fa-map-marker-alt"></i> Alamat
                </h4>
                <p class="text-gray-300 text-sm leading-relaxed">
                    Jl. Bunga, Geblagan, Tamantirto, Kec. Kasihan, Kabupaten Bantul, DIY 55184
                </p>

                <div class="mt-3 text-sm text-gray-300 space-y-1">
                    <p><i class="fas fa-clock text-yellow-400 mr-2"></i>Weekday: 08:00 - 20:00</p>
                    <p class="ml-6">Weekend: 10:00 - 19:00</p>
                </div>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <li class="flex items-center gap-2">
                        ...
                        <a href="tel:14022" class="hover:text-yellow-400 text-gray-300">14022</a>
                    </li>

                    <li class="flex items-center gap-2">
                        <i class="fas fa-envelope text-yellow-400"></i>
                        <a href="mailto:info@burjominang.com" class="hover:text-yellow-400 text-gray-300">
                    ...
                    <li class="flex items-center gap-2">
                        ...
                        <a href="https://wa.me/628123456789" class="hover:text-yellow-400 text-gray-300">
                            +62 812-3456-7890
                        </a>
                    </li>
                </ul>
                ...
                <ul class="space-y-2 text-sm">
                    <li>
                        <a href="<?php echo e(auth()->check() ? route('dashboard') : route('login')); ?>"
                           class="text-gray-300 hover:text-yellow-400 flex items-center gap-2">
                            <i class="fas fa-utensils text-xs"></i> Dine In
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="<?php echo e(auth()->check() ? route('dashboard') : route('login')); ?>"
                           class="text-gray-300 hover:text-yellow-400 flex items-center gap-2">
                            <i class="fas fa-shopping-bag text-xs"></i> Take Away
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div>
                ...
                <div class="flex gap-4">
                    <a href="https://www.instagram.com/burjominang/"
                       class="w-10 h-10 rounded-lg bg-gradient-to-br from-purple-600 to-pink-500 flex items-center justify-center hover:scale-110 transition">
                        <i class="fab fa-instagram text-white text-lg"></i>
                    </a>

                    <a href="#"
                       class="w-10 h-10 rounded-lg bg-blue-600 flex items-center justify-center hover:scale-110 transition">
                        <i class="fab fa-facebook-f text-white text-lg"></i>
                    </a>

                    <a href="#"
                       class="w-10 h-10 rounded-lg bg-green-600 flex items-center justify-center hover:scale-110 transition">
        ...
        <div class="border-t border-gray-700 mt-10 pt-5 text-center text-sm text-gray-400">
            © <?php echo e(date('Y')); ?> <span class="text-yellow-400 font-semibold">Burjo Minang</span> • Jagonya Rasa Original
        </div>
...
</html><?php /**PATH D:\Capstone\capstone 2\capston2\resources\views/welcome.blade.php ENDPATH**/ ?>