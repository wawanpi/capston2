...
<?php endif; ?>
                    ...
                    <div class="mt-6 text-center text-sm text-gray-500">
                        Sudah punya akun? 
                        <a href="<?php echo e(route('login')); ?>" class="font-bold text-red-700 hover:text-red-900 hover:underline transition-colors">
                            Masuk di sini
                        </a>
                    </div>
                </form>
...
<?php endif; ?><?php /**PATH D:\Kuliah\S7\capstonne\CapstoneProject\resources\views/auth/register.blade.php ENDPATH**/ ?>