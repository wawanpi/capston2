...
<body class="bg-white" x-data="{ open: false }">
        ...
        <nav class="container mx-auto px-4 py-2 flex justify-between items-center h-[68px]">
            ...
            <div class="flex-grow flex justify-center lg:flex-grow-0 lg:justify-start items-center">
                 <a href="/" class="flex items-center" aria-label="Homepage">
                     <img src="https://kfcindonesia.com/static/media/kfc-logo.02742817.png" alt="KFC Jagonya Ayam" class="h-10 lg:h-12">
                 </a>
            </div>
            ...
            <div class="flex items-center space-x-3 flex-shrink-0">
                ...
                <a href="#" class="hidden lg:flex items-center bg-white border border-gray-300 text-gray-700 px-4 py-2 rounded-full font-semibold text-sm shadow-sm hover:border-gray-400 transition duration-200">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-4 h-4 mr-2 text-kfc-red"> <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-2.63 C11.26 15.22 8.78 12.74 7.043 10.014l1.293-.97c.362-.271.527-.734.417-1.173L7.353 3.602a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25Z" /> </svg>
                    <span class="mr-2">Contact Us</span> <span class="font-bold text-kfc-red">14022</span>
                </a>
            </div>
        </nav>
    </header>
    ...
    <footer class="bg-[#1C1C1C] text-gray-400 py-10 px-4 mt-16">
         <div class="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-sm">
             <div class="md:col-span-1"> <h4 class="font-bold text-white mb-3 uppercase">PT Fast Food Indonesia Tbk</h4> <p>Alamat : Jl. MT Haryono Kav 7,<br> Jakarta Selatan 12810, Indonesia</p> <p class="mt-2">Operating hours:<br> Weekday : 08:00 - 20:00<br> Weekend : 10:00 - 19:00</p> <p class="mt-2">Telephone: <span class="font-semibold">14022</span></p> <p>E-mail: info@kfcindonesia.com</p> </div>
             <div class="md:col-span-1"> <h4 class="font-bold text-white mb-3 uppercase">Layanan</h4> <ul class="space-y-1"> <li><a href="#" class="hover:text-white">Delivery Order</a></li> <li><a href="#" class="hover:text-white">Dine in</a></li> <li><a href="#" class="hover:text-white">Take Away</a></li> <li><a href="#" class="hover:text-white">Catering</a></li> <li><a href="#" class="hover:text-white">Drive Thru</a></li> </ul> </div>
