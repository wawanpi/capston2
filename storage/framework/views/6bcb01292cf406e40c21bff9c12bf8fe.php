...
>
    ...
    <div class="p-4 flex items-center gap-3 border-b">
        ...
        <div>
            ...
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="font-semibold text-gray-800 hover:text-kfc-red">Login / Daftar</a>
            <?php endif; ?>
        </div>
    </div>
        ...
        <?php if(auth()->guard()->check()): ?>
            ...
            <div class="border-t pt-2 mt-2">
                <form method="POST" action="<?php echo e(route('logout')); ?>" class="w-full">
                    <?php echo csrf_field(); ?>
                    <a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); this.closest('form').submit();" class="flex items-center gap-3 p-3 rounded-lg text-red-600 hover:bg-red-50 w-full">
